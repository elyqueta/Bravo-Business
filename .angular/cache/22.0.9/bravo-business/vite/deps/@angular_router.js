...
function setupNewRouterResources(snapshot, route, abortSignal, blockingResourcePromises) {
  return __async(this, null, function* () {
...
var VERSION = new Version("22.1.7");
export {
  ActivatedRoute,
  ...
  nonBlocking as ɵnonBlocking,
  withRouterResources as ɵwithRouterResources
};
